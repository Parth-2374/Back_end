                ...
                <tr>
                  <td>
                    <div class="media">
                      <div class="d-flex">
                        <img
                          src="Product_picture/<%=p.getProduct_image() %>"
                ...
                <tr class="out_button_area">
                  ...
                  <td>
                    <div class="checkout_btn_inner">
                      ...
                      <button type="button" id="payButton" onclick="CreateOrderID()" class="main_btn">Proceed to checkout</button>
                    </div>
                  </td>
                </tr>
              </tbody>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
	...
	{	
		xhttp.open("GET","http://localhost:8081/Project/OrderCreation?amount=<%=net_price%>",false);
		xhttp.send();
	...
	function OpenCheckOut()
	{
		...
		var options={
				"key":"rzp_test_SjahKk10iiy2ZJ",
				"amount":new_amount,
				"currency":"INR",
				"name":"Product",
				"description":"Test",
				 "order_id": RazorpayOrderId,
			"callback_url":"http://localhost:8081/Project/OrderCreation",
				"prefill" : {
					"name" : "Parth ",
