	    ...
	    <div class="main_menu">
	      <div class="container-fuild p-3">
	        <nav class="navbar navbar-expand-lg navbar-light w-100">
	          ...
	          <a class="navbar-brand logo_h  " sty href="index.jsp">
	            ...
	            <div class="row w-100 mr-0">
	              <div class="col-lg-9 pr-0">
	                ...
	                %>
	                  ...
	                  <li class="nav-item">
	                    <a class="nav-link" href="profile.jsp"><img src="Profile_picture/<%=u.getProfile_picture()%>"style="width: 50px;height: 50px; border-radius: 50%"></a>
	                  </li>
	                  <%
	                	}
	                  %>
	                ...
	                <ul class="nav navbar-nav navbar-right right_nav pull-right">
	                  ...
	                  <li class="nav-item">
	                    <a href="cart.jsp" class="icons">
	                      <i class="ti-shopping-cart"><%=session.getAttribute("cart_count") %></i>
	                    </a>
	                  </li>
	                  ...
	                  <li class="nav-item">
	                    <a href="wishlist.jsp" class="icons">
	                       <i class="ti-heart"><%=session.getAttribute("wishlist_count") %></i>
	                     </a>
	                  </li>
