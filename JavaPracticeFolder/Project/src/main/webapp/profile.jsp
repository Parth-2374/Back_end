  ...
  <section class="section_gap">
    <div class="container">
      <div class="row">
        ...
        %>
          <form enctype="multipart/form-data" class="form-contact contact_form" method="post"  action="UserController">
            <div class="row ">
             <div class="col-sm-6 ">
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  <input class="form-control" name="email" id="email" type="email" readonly="readonly" value="<%=u.getEmail() %>">
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">
              ...
              <div class="col-12">
                <div class="form-group">
                    <img src="Profile_picture/<%=u.getProfile_picture() %>" style="width: 100px;height: 100px;border-radius: 50%" >
                </div>
              </div>
              <div class="col-12">
                <div class="form-group">
            ...
            <div class="form-group mt-lg-3">
              <button type="submit" name="action" value="update profile" class="main_btn">Update Profile </button>
            </div>
          </form>
