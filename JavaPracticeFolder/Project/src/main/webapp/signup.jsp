          ...
          <form enctype="multipart/form-data" class="form-contact contact_form" method="post"  action="UserController">
            ...
            <div class="col-sm-12">
             ...
             <div class="col-sm-6">
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  <input class="form-control" name="mobile" id="name" type="text" placeholder="Enter your mobile">
                </div>
              </div>
              <div class="col-12">
                <div class="form-group">
             ...
             <div class="col-sm-6">
                <div class="form-group">
                  <input class="form-control" name="password" id="name" type="password" placeholder="Enter password">
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">
                  <input class="form-control" name="cpassword" id="name" type="password" placeholder="Enter confirm password">
                </div>
              </div>
